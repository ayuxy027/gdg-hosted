      ...
      <section className="py-20 bg-blue-600">
        <div className="px-4 mx-auto text-center text-white max-w-7xl sm:px-6 lg:px-8">
          ...
          <p className="max-w-3xl mx-auto text-xl">
            We are a community of developers passionate about Google
            technologies and dedicated to learning, sharing, and building
            together.
          </p>
        </div>
      </section>
          ...
          <div className="grid gap-12 md:grid-cols-3">
            <div className="text-center">
              ...
              <p className="text-gray-600">
                To create an inclusive environment where developers can network,
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                Community, Innovation, Knowledge sharing, and Inclusivity are at
            ...
            <div className="text-center">
              ...
              <p className="text-gray-600">
                To empower developers to build innovative solutions that make a
