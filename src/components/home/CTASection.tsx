  ...
  <section className="py-16 bg-white sm:py-20">
    ...
    >
      ...
      <a
        ...
        className="inline-flex gap-2 items-center px-6 py-3 text-base font-medium text-white bg-blue-500 rounded-2xl transition-all duration-300 sm:px-8 sm:py-4 sm:text-lg hover:bg-blue-700"
      >
        Join Now
